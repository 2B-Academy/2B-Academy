    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex align-items-center">
                <h5 class="mb-0"> <i class="bi bi-grid-fill"></i> المصادر الخاصة بدورة <span
                ...
                <div class="card-body">
                    ...
                    @if (count($content) > 0)
                        <div class="col-12 text-end">
                            <a href="{{ route('admin.courses.resources.destroyAll', $course) }}"
                                class="delete btn btn-outline-danger"><i class="mx-1 lni lni-trash"></i> حذف كل المصادر</a>
                        </div>
                    @endif
                                                    ...
                                                    @foreach ($content as $con)
                                                        <div class="col-12 mb-3" id="row">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="input w-100">
                                                                    <label>الملف <small
                                                                            class="text-danger">(pdf,doc,docx,xls,xlsx)</small>
                                                                        @if ($con->file)
                                                ...
                                                @else
                                                    <div class="col-12 mb-3" id="row">
                                                        <div class="d-flex align-items-center justify-content-around gap-4">
                                                            ...
                                                            <div class="input w-100">
                                                                <label>الرابط</label>
                                                                <input type="url" dir="ltr" class="form-control"
                                                                    name="link[]" placeholder="https://****">
                                                            </div>
                                                            <div class="input w-100">
                                                                <label>الملف <small
                                                                        class="text-danger">(pdf,doc,docx,xls,xlsx)</small></label>
